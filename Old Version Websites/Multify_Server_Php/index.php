    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapsing-section">
            <ul class="nav navbar-nav home-nav-bar navbar-right">
                <li><a href="#" id="deneyim"><p class="banner">Multify Deneyimi</p></a></li>
                <li><a href="#" id="how-it-works"><p class="banner">Nasıl Çalışır?</p></a></li>
                <li>
                    <button class="btn btn-xs btn-red navbar-btn home-button visible-lg visible-md visible-sm"
                            id="pre-purchase"><p class="banner">Ön
                            Sipariş Ver</p></button>
                    <a href="#" id="pre-purchase" class="visible-xs"><p class="banner">Ön Sipariş Ver</p></a>
                </li>
                <li><a href="#" id="changeLang" onclick="clickLang()"><img src="img/en.png" id="lang-logo"
                                                                           class="img-circle visible-lg visible-md visible-sm"
                                                                           height="31" width="31"/>

                        <p class="banner visible-xs">Switch to English</p></a></li>
                <li>
                    <button class="btn btn-xs btn-warning navbar-btn home-button visible-lg visible-md visible-sm"
                            ...
                            class="banner">Giriş</p></button>
                    <a href="clientMultify" id="login" class="visible-xs"><p class="banner">Giriş</p></a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container">
    <div class="row" style="margin-top:25px; margin-bottom:25px">
        ...
        <h1 class="heading" id="toDeneyim"><b>MULTIFY DENEYİMİ</b></h1>
        ...
        <div class="col-lg-12" id="first-row">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 vertical-align">
                    <p class="description">Multify, işletmenizin sosyal medyadaki değerini hayatımızın
                        içine
                        yansıtarak,
                        bu değeri bir pazarlama aracı olarak kullanmanızı sağlar.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 vertical-align">
                    <p class="description">Multify, onaylanmış beğeni olgusunu gerçek hayata yansıtarak müşteri
                        sayınızı
                        arttırırken, kendini sürekli güncelleyen yapısı sayesinde sizinle müşterileriniz
                        arasında
                        interaktif bir ortam yaratır.</p>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 vertical-align">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 vertical-align">
                    <p class="description">Multify, bir pazarlama aracı olmasının yanında; işletmenizde yer
                        almasını
                        isteyeceğiniz bir ürün olarak sizin için tasarlandı.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 vertical-align">
                    <p class="description">Multify'ı satın aldıktan sonra, ek olarak aylık müşteri analiz
                        raporunu
                        satın
                        alabilir, müşteri profilinizi daha iyi anlayabilir ve gelirinizi arttırabilirsiniz.</p>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 vertical-align">
...
<div class="container">
    <div class="row" id="how-it-works-row" style="margin-top:25px; margin-bottom:25px">
        <h1 class="heading" id="toWorks"><b>NASIL ÇALIŞIR?</b></h1>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            ...
            <div class="row">
                <p class="heading-minor"><b>MULTIFY' I İŞLETMENE YERLEŞTİR</b></p>

                <div class="subheading2">
                    <p class="description">Farklı tasarımları olan Multify'ı işletmenizin duvarına asarak
                        veya masa üzerinde kullanabilirsiniz.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            ...
            <div class="row">
                <p class="heading-minor"><b>SADECE PRİZE TAK!</b></p>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            ...
            <div class="row">
                <p class="heading-minor"><b>WI-FI BAĞLANTISI KUR</b></p>

                <div class="subheading2">
                    <p class="description">Bilgi aktarımı için WI-FI bağlantısı gereklidir.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="row" style="margin-top:25px; margin-bottom:25px">
        <h1 class="heading" id="sizes" style="margin-bottom:50px"><b>ÖLÇÜLER</b></h1>
...
<div class="container" style="margin-top:25px; margin-bottom:25px">
    <div class="row">
        ...
        <div class="subheading" id="toPurchase">
            ...
            <p class="text-center heading" style="margin-top:25px; margin-bottom:25px">Ön Sipariş Ver</p>
            ...
            <div class="center-block form-div">
                <form class="form-horizontal" action="sendMessage.php" method="post">
                    <div class="form-group" style="margin: 5px auto;">
                        <label for="venueName" class="col-sm-2 control-label">İşletme Adı: </label>

                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="venueName" placeholder="İşletme Adı"
                    ...
                    <div class="form-group" style="margin: 5px auto;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name" placeholder="Ad Soyad" name="name"
                                   required/>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin: 5px auto;">
                        <div class="col-sm-10">
                            <input type="checkbox" class="pull-right" name="sozlesme" id="sozlesme_id"
                                   aria-label="Mesafeli Satış Sözleşmesini Onaylıyorum" required>
                            <label for="sozlesme_id" class="pull-right"> <a href="#" data-toggle="modal" data-target="#sozlesmeModal">Mesafeli Satış Sözleşmesini</a>
                                Onaylıyorum </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group" class="pull-right" style="margin: 5px auto;">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-red pull-right">GÖNDER</button>
                        </div>
                    </div>
                </form>
...
<div class="container" style="margin-bottom: 20px">
    <div class="row">
        <div class="subheading">
            <p class="text-center" style="margin-top: 50px;">Gelişmelerden haberdar olmak için e-posta adresinizi
                bırakın.</p>
            ...
            <div class="center-block form-div">
                <form class="form-horizontal" action="subscribe.php" method="post">
                    ...
                    <div class="form-group" style="margin: 5px auto;">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-red pull-right">KAYDOL</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="row footer" style="padding-top: 30px">
        <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <li>
                    <a href="#" data-toggle="modal" data-target="#sozlesmeModal">Mesafeli Satış Sözleşmesi</a>
                </li>
                <!--
                <li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 class="modal-title" id="myModalLabel">Mesafeli Satış ve Kiralama Sözleşmesi</h2>
            </div>
