...
class AuthenticationGateway extends EndpointGateway
{
    ...
    public function authenticateUser($code)
    {
        ...
        $jSON = array ('client_id' => $this->clientId,'client_secret' => $this->clientSecret,'grant_type' => 'authorization_code', 'redirect_uri' => $this->redirectUri, 'code' => $code);
        //var_dump($jSON);
        //var_dump($this->httpClient->get($this->accessTokenUri, $jSON));
