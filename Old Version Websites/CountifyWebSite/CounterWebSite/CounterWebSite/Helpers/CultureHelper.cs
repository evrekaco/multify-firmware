...
namespace CounterWebSite.Helpers
{
    public static class CultureHelper
    {
        ...
        // Includes ONLY implemented cultures
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            // the function will return closest match ("en-US" in this case)
        ...
        /// <summary>
        /// Returns the current culture (i.e. 'en-US')
        /// </summary>
        ...
        /// <summary>
        /// Return the current neutral culture (i.e. 'en' if the current culture is 'en-US')
        /// </summary>
        ...
        /// <summary>
        /// Takes a culture name and returns the neutral culture
        /// </summary>
